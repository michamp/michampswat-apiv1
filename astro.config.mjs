...
export default defineConfig({
  ...
  integrations: [react(), icon({
    include: {
      ...
      'user-add-line','chat-new-line', 'code-box-line', 'menu-2-fill', 'file-list-3-line','user-add-line','home-2-line','user-3-line','database-2-line','building-4-line','police-badge-line','global-line',
      'signal-wifi-error-line','login-box-line','logout-box-line','run-fill',
      'money-dollar-box-line','lock-2-line','kanban-view-2','flag-fill','user-forbid-line',
      'folder-info-fill','newspaper-line'],
    }
  }), tailwind()]
});
